...
create table vz_countries(
country_id INT NOT NULL,
country_name VARCHAR(256),
PRIMARY KEY(country_id)
);

create table vz_states(
state_id INT NOT NULL,
state_name VARCHAR(256),
country_id INT,
PRIMARY KEY(state_id),
FOREIGN KEY(country_id) REFERENCES vz_countries(country_id)
);

create table vz_cities(
...
PRIMARY KEY(city_id),
FOREIGN KEY(country_id) REFERENCES vz_countries(country_id),
FOREIGN KEY(state_id) REFERENCES vz_states(state_id)
);
...
FOREIGN KEY(country_id) REFERENCES vz_countries(country_id),
FOREIGN KEY(state_id) REFERENCES vz_states(state_id),
FOREIGN KEY(city_id) REFERENCES vz_cities(city_id)
);
...
user_id INT,
PRIMARY KEY(post_id), 
FOREIGN KEY(category_id) REFERENCES vz_categories(category_id),
FOREIGN KEY(user_id) REFERENCES vz_users(user_id)
);
...
FOREIGN KEY(auth_id) REFERENCES vz_users(user_id),
FOREIGN KEY(country_id) REFERENCES vz_countries(country_id),
FOREIGN KEY(state_id) REFERENCES vz_states(state_id),
FOREIGN KEY(city_id) REFERENCES vz_cities(city_id),
FOREIGN KEY(zip_id) REFERENCES vz_zip(zip_id)
